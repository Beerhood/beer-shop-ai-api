...
exports.handleNotFoundPrompt =
  exports.synthesizeSuccessResponsePrompt =
  exports.getBeerCriteriaPrompt =
    void 0;
const getBeerCriteriaPrompt = (userPrompt) => `
...
**Your response:**
`;
exports.getBeerCriteriaPrompt = getBeerCriteriaPrompt;
const synthesizeSuccessResponsePrompt = (products, query) => {
...
exports.synthesizeSuccessResponsePrompt = synthesizeSuccessResponsePrompt;
const handleNotFoundPrompt = (query, criteria) => {
...
exports.handleNotFoundPrompt = handleNotFoundPrompt;
//# sourceMappingURL=beer-recommendation.prompts.js.map
